...
![Screen Shot 2021-11-30 at 12.24.22 PM](/Users/lingfeng/Desktop/Screen Shot 2021-11-30 at 12.24.22 PM.png)
...
def Make_prime(key_size: int) -> int:
    while True:
        num = random.randrange(qpow(2, key_size - 1), qpow(2, key_size))
        if Miller_Rabin(num):
            return num
...
if __name__ == '__main__':
    ...
    r_fake = random.randint(10 ** 150, 10 ** 160)
    s_fake = random.randint(10 ** 150, 10 ** 160)
    x_fake = random.randint(10 ** 150, 10 ** 160)
    ...
    if Verify(x, p, alpha, beta, r, s):
        ...
        print("invalid")
    print("x' (faked): ", x_fake)
    print("Verify (r, s) of x': ")
    if Verify(x_fake, p, alpha, beta, r_fake, s_fake):
        print("valid")
    else:
        print("invalid")

    print("r' (faked): ", r_fake)
    print("s' (faked): ", s_fake)
    print("Verify (r', s') of x: ")
    if Verify(x, p, alpha, beta, r_fake, s_fake):
        print("valid")
    else:
        print("invalid")
